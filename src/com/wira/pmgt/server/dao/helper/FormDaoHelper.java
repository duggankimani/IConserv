...
import com.wira.pmgt.server.dao.model.ADKeyValuePair;
import com.wira.pmgt.server.dao.model.ADProperty;
import com.wira.pmgt.server.dao.model.ADValue;
import com.wira.pmgt.server.dao.model.HasProperties;
import com.wira.pmgt.server.dao.model.PO;
import com.wira.pmgt.server.db.DB;
import com.wira.pmgt.server.db.LookupLoader;
import com.wira.pmgt.server.db.LookupLoaderImpl;
import com.wira.pmgt.server.helper.dao.JaxbFormExportProviderImpl;
...
import static com.wira.pmgt.client.ui.admin.formbuilder.HasProperties.*;
			...
			if(prop.getName().equals(SELECTIONTYPE)){
				...
				if(selectionKey==null || selectionKey.trim().isEmpty()){
					...
					prop.setValue(new StringValue(null, 
							com.wira.pmgt.client.ui.admin.formbuilder.HasProperties.SELECTIONTYPE,
							selectionKey));
				}
				break;
